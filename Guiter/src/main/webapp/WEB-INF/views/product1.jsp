			...
			<div class="col-md-12">
				<div class="papers">
					...
					<spring:form
						...
						<c:choose>
							<c:when test="${not empty product.productid}">  <!-- checking if product.productid is not null then disables the input box -->
								<div class="control-group">
									<div class="controls">
										<!-- <label class="control-label" for="catogoryid">Product
											ID</label> -->
						...
						<div class="control-group">
							...
							<div class="controls">
								<label class="control-label" for="userid">Product
									Description</label>
								<spring:input type="text" id="description"
							...
							<div class="controls">
								<label class="control-label" for="userid">Product
									Price</label>
								<spring:input type="text" id="price"
									path="price" placeholder="Product Price"
									class="input-sm" />
									</div>
									<div>
									<div class="control-group">
