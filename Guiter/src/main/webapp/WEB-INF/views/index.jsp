...
<div class="wrapper" id="wrapper">
	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="papers text-center">
					<img src="resources/img/vsguiters.jpg" height="426" width="640" alt=""><br/>
					<a href="#"><b>Download my resume</b></a>
					<h4 class="notopmarg nobotmarg">More About Grason Guiters</h4>
					<p>
						Have you ever felt worried that your party will not raise up to your guest expectations? In design, vertical rhythm is the structure that guides a reader's eye through the content. Good vertical rhythm makes a layout more balanced and beautiful and its content more readable. The time signature in sheet music visually depicts a song's rhythm, while for us, the lines of the baseline grid depict the rhythm of our content and give us guidelines.
					</p>
				</div>
		...
		<div class="row">
			<div class="col-md-4">
				<div class="restmenuwrap">
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image:url('resources/img/show-img.jpg')">
						</div>
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image: resources/img/show-img2.jpg">
						</div>
						<h5>Luxur Oyster</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image: resources/img/strrringg.jpg">
						</div>
						<h5>Sweet, Sticky and Spicy Chicken</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
			...
			<div class="col-md-4">
				<div class="restmenuwrap">
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image: resources/img/tune.jpg">
						</div>
						<h5>Sweet, Sticky and Spicy Chicken</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image: resources/img/harry.jpg">
						</div>
						<h5>Luxur Oyster</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image: resources/img/piciii.jpg">
						</div>
						<h5>Sweet, Sticky and Spicy Chicken</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
			...
			<div class="col-md-4">
				<div class="restmenuwrap">
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image: resources/img/learning.jpg">
						</div>
						<h5>Luxur Oyster</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
					...
					<div class="restitem clearfix">
						<div class="rm-thumb" style="background-image:resouces/img/learning.jpg">
						</div>
						<h5>Sweet, Sticky and Spicy Chicken</h5>
						<p>
							Pepperoni, mozzarella cheese and Italian seasonings are rolled together, baked to delicious perfection, then cut into bite-sized delights. Your guests will beg for the recipe!"
			...
			<div id="grid-gallery" class="grid-gallery">
					...
					<section class="grid-wrap">
						<ul class="grid">
							...
							<li>
								<figure>
									<img src="resources/img/cons4.jpg" alt=""/>
							...
							<li>
								<figure>
									<img src="resources/img/cons3.jpg" height="183" width="275"  alt=""/>
							...
							<li>
								<figure>
									<img src="resources/img/add2.jpg" height="183" width="275"  alt=""/>
							...
							<li>
								<figure>
									<img src="resources/img/add3.jpg" height="183" width="275"  alt=""/>
									<figcaption><h3>Brunch semiotics</h3><p>Ex disrupt cray yr, butcher pour-over magna umami kitsch before they sold out commodo.</p></figcaption>
								</figure>
							</li>
